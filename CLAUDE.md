...
❓ Pending decisions: keep vs archive `Project_Journey_Complete.md` (note: v6.6's ~86% flood-duplication figure currently traces only to this file — re-anchor to `numbers_map.md` before archiving); whether the venvs stay tracked. (`chore/bootstrap-claude` pushed 2026-07-28 — in sync with origin.)
