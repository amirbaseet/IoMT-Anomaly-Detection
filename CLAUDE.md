...
❓ Pending decisions: keep vs archive `Project_Journey_Complete.md` (**archive blocker removed 2026-07-30** — the ~86% figure is now anchored in `numbers_map.md` via DR-6b; PJ has uncommitted user edits, so still the user's call); whether the venvs stay tracked. (`chore/bootstrap-claude` in sync with origin as of 2026-07-30.)
