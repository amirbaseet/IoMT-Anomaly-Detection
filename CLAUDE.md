...
1c. **Memorization-premium doc sweep** (post-C1-multiseed, joint with the P1 arc): align gap report §3, summary, v6.6 §2.4.2, thesis Ch1/Ch5 wording with the retired claim (test-set effect +0.35–0.40pp is the separable finding).
