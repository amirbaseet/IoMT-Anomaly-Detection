...
1c. ~~Memorization-premium doc sweep~~ **RESOLVED 2026-07-30**: gap report §3 + summary corrected by the P1 arc (lit-review 936114d); thesis Ch1 §1.1 rewritten with the withdrawal + separable +0.35–0.40pp finding (manuscript dd00e12); v6.6 §2.2.8 verified as cost-framing (no premium claim — survives unchanged).
