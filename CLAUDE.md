...
❓ Pending decisions: keep vs archive `Project_Journey_Complete.md`; whether the venvs stay tracked; push `chore/bootstrap-claude` (several local commits ahead, incl. this arc's docs commits).
