...
0. ~~Gap-doc + v6.6 integration of #31–#34 + report draft~~ **DONE 2026-07-29**; ~~advisor format confirmation + §2.6 reference entries~~ **DONE 2026-07-30** (top entry). Remaining from that arc: the user sends `Research_Gap_Report_v1.0.md` + `Research_Gap_Summary_v1.0.md` to the advisor (nothing gates it).
