...
0. **Gap-doc + v6.6 integration of #31–#34** (blocks the report draft): reword G2/G3 for PSM-HT, update G8 FPR roster (five), G10 exceptions (four), M8 code count (four), add §3.3/§5 entries, fix denominators; then landscape fill (IoMT-TrafficData/ECU-IoHT/CICIoT2023 from #15/#20/R1/R5) and draft the standalone report per the frozen brief.
