...
>
> **What we found**
> - Empirical result: 9 fixes shipped under named commits; multi-seed H2-strict avg 0.799 ± 0.023, 0/18 eligible cells fail; continuous sweep reveals p93.0 refined optimum (+5.5 pp); per-fold KS uniform [0.0543, 0.0573]; SHAP background Kendall τ = 0.927; β-VAE Δ strict = −0.0001; LSTM-AE c1 Δ strict = +0.0341 with capacity-vs-fusion inverse finding.
