...
**Plateau structure (the published p95 sits exactly on the lip).** The discrete grid {p90, p95, p99} chosen in Phase 6C hid an important plateau structure. The continuous sweep reveals that p95.0 sits exactly at the lip of the 4/4 strict-pass plateau — any small upward perturbation (p95.5) drops to 3/4. p93.0 sits comfortably in the middle of the plateau, providing both higher recall and stability margin against threshold drift. Under a 0.25 FPR budget, p93.0 is the refined operating-point recommendation; the published p95.0 result remains valid but is no longer optimal.
